...
radius or restore the paper's integer storage binaries simply by editing the
defaults here and committing the change.
"""

# ADMM penalties appearing in the augmented Lagrangian (paper calls them rho_a,
# rho'_a). Baseline uses rho_a = 1.0, rho_l = 1.0. This node tests RHO_A = 4.0
# to probe convergence / result stability (claim C1, C3).
RHO_A = 4.0
RHO_L = 1.0
...
# Solver options tuning (convergence tightness for claim C1).
OUTER_EPS = 1e-3
INNER_EPS = 1e-3
